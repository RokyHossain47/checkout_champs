                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control" required placeholder="Enter category slug" value="{{ old('slug') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="parent_id" class="form-control" placeholder="Enter parent category ID (optional)" value="{{ old('parent_id') }}">
                        </div>
                        <div class="mb-3">
